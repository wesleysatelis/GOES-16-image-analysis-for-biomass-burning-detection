...
for d in dias:
    ...
    while len(os.listdir(incomming)) > 0:
        ...
        for fl in files_proc:
            if fl.endswith("ascii--L1B.C07.txt"):
                sp_files.append(fl)

    os.system("tar -czf " + "/home/ess/wesley/" + sp_files[0][0:8] + "_C07.tar.gz" + ' ' + processed + "/*SP_7_ascii--L1B*.txt")
    os.system("rm /ess/data/satellite/goes/grb/level1b/*.nc /ess/data/processed/*SP_7_ascii--L1B*")
